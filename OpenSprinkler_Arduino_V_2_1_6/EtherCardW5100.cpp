...
EthernetServer EtherCardW5100::w5100server ( hisport );
EthernetClient EtherCardW5100::w5100client;
EthernetUDP EtherCardW5100::w5100udp;
...
bool EtherCardW5100::dhcpSetup ( const char *hname, bool fromRam )
{
    ...
    // TODO - Ignore the name for now - need to use an extension for the standard Arduino ethernet library to implement this
...
void EtherCardW5100::printIPConfig()
{
    ...
    printIp ( F ( "Gateway IP: " ), myip );
    printIp ( F ( "DNS IP:     " ), myip );
    printIp ( F ( "Netmask:    " ), myip );
...
uint16_t EtherCardW5100::packetLoop ( uint16_t plen )
{
    ...
    EthernetClient w5100client = w5100server.available();
    int i = 0;
...
word EtherCardW5100::packetReceive()
{
